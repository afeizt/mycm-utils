(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/es.date.to-string.js'), require('core-js/modules/es.regexp.constructor.js'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.regexp.to-string.js'), require('core-js/modules/es.string.replace.js'), require('core-js/modules/es.array.includes.js'), require('core-js/modules/es.array.slice.js'), require('core-js/modules/es.object.to-string.js'), require('core-js/modules/es.string.match.js'), require('core-js/modules/es.string.search.js'), require('core-js/modules/es.string.split.js')) :
	typeof define === 'function' && define.amd ? define(['core-js/modules/es.date.to-string.js', 'core-js/modules/es.regexp.constructor.js', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.regexp.to-string.js', 'core-js/modules/es.string.replace.js', 'core-js/modules/es.array.includes.js', 'core-js/modules/es.array.slice.js', 'core-js/modules/es.object.to-string.js', 'core-js/modules/es.string.match.js', 'core-js/modules/es.string.search.js', 'core-js/modules/es.string.split.js'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.mycmUtils = factory());
